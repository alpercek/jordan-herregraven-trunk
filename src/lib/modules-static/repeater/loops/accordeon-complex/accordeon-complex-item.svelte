...
{#if item}
	<div transition:slide={{ duration: 300 }}>
		<!-- Header -->
		<div on:click={toggle} class="{item.uid} w-full flex cursor-pointer textHoverGrey text-xl py-3 px-4 ">
		...
		<!-- Content -->
		{#if interalStatus == true}
			<div class="bg-neutral-100 w-full  py-4 pl-4 pr-6" transition:slide={{ duration: 300 }}>
